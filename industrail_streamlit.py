...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"F:\\Industrial copper.py\\model.pkl",'rb') as file:  
            loaded_model = pickle.load(file)
        with open(r"F:\\Industrial copper.py\\scaler.pkl",'rb') as file: 
            scaler_loaded = pickle.load(file)
        with open(r"F:\\Industrial copper.py\\t.pkl",'rb') as file:
            t_loaded = pickle.load(file)
        with open(r"F:\\Industrial copper.py\\s.pkl",'rb') as file:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"F:\\Industrial copper.py\\cmodel.pkl", 'rb') as file:      

            cloaded_model = pickle.load(file)
        with open(r"F:\Industrial copper.py\\cscaler.pkl", 'rb') as file:

            cscaler_loaded = pickle.load(file)
        with open(r"F:\\Industrial copper.py\\ct.pkl", 'rb') as file:
